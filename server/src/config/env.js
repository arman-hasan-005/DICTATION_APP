...
const optionalWarnings = {
  GOOGLE_TTS_KEY:
    "⚠️  GOOGLE_TTS_KEY not set — browser voice fallback will be used",
  GOOGLE_VISION_KEY:
    "⚠️  GOOGLE_VISION_KEY not set — handwriting OCR will use Tesseract.js fallback",
  GOOGLE_CLIENT_ID:
    "⚠️  GOOGLE_CLIENT_ID not set — Google OAuth will be disabled",
  GOOGLE_CLIENT_SECRET:
    "⚠️  GOOGLE_CLIENT_SECRET not set — Google OAuth will be disabled",
...
module.exports = {
  ...
  emailFrom:
    process.env.EMAIL_FROM || process.env.SMTP_USER || "noreply@dictaclass.com",
  backendUrl:
